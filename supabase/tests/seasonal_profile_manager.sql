...
select test.assert((select seasonal_snapshot->>'profileType'='Normal' and seasonal_snapshot->>'percentageMultiplier'='100' from public.read_shared_location_draft('10000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','bar')),'existing draft remains pinned to Normal 100');
...
select test.assert((select seasonal_snapshot->>'profileType'='Offseason' and seasonal_snapshot->>'percentageMultiplier'='75' from public.read_shared_location_draft('10000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','merchants')),'new draft pins Offseason 75');
