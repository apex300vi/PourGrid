...
do $$declare denied boolean:=false;begin begin perform public.configure_seasonal_profile('10000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000002','{"profileType":"Offseason","percentageMultiplier":75}');exception when others then denied:=true;end;perform test.assert(denied,'cross-tenant configure is denied');end$$;
reset role;
set role authenticated;
select set_config('request.jwt.claim.sub','00000000-0000-0000-0000-000000000003',false);
do $$declare denied boolean:=false;begin begin perform public.configure_seasonal_profile('10000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','{"profileType":"Peak season","percentageMultiplier":125}');exception when others then denied:=true;end;perform test.assert(denied,'staff configure is denied');end$$;
reset role;
