...
const sql=fs.readFileSync('supabase/migrations/202608180001_transactional_order_save.sql','utf8');
...
test('save RPC is transactional and duplicate retries return the original order',()=>{
  ...
  assert.match(sql,/unique\(organization_id,location_id,draft_id\)/);
