...
export interface Database { public: { Tables: {
  ...
  order_lines: { Row: { id:string; order_id:string; item_id:string; draft_units:number; submitted_units:number|null; expected_units:number|null; received_units:number; units_per_package:number } };
...
}; Functions: { finalize_receiving:{ Args:{p_session:string}; Returns:undefined }; approve_reconciliation:{Args:{p_request:string;p_approved:boolean};Returns:undefined} }; Enums:{app_role:AppRole;workflow_kind:WorkflowKind} } }
