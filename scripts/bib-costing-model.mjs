...
export const BIB_PRODUCTS=Object.freeze([
  ...
  {key:'cranberry-bib',name:'BIB Cranberry',packageOz:384,purchasePrice:57.80,waterParts:4,basis:WATER_PARTS_PER_ONE_SYRUP,source:'Harvest Valley 19% Cranberry Juice Cocktail, GFS item 758477, 3 gal BIB, 4 parts water to 1 part concentrate.',sourceUrl:'https://gfsstore.com/products/758477/',supplierProductId:'758477'},
