...
const files=['index.html','phase3.html','auth.css','auth-recovery.css','auth-state.mjs','manifest.webmanifest','sw.js','pwa-register.js','property-context.js','property-catalog.js','order-guide-template.js','bottle-intelligence.js','smart-count-launcher.js','pourgrid-vision.js','product-persistence.js','history-analytics.js','seasonal-profiles.js','predictive-ordering.js','order-pipeline.js','order-save.js','shared-drafts.js','drink-price-estimator.js','phase3-domain.js','sapphire-logo-original.png'];
