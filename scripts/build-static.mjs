...
const files=['index.html','phase3.html','auth.css','auth-recovery.css','auth-state.mjs','manifest.webmanifest','sw.js','pwa-register.js','bottle-intelligence.js','smart-count-launcher.js','pourgrid-vision.js','product-persistence.js','order-pipeline.js','drink-price-estimator.js','phase3-domain.js','sapphire-logo-original.png'];
